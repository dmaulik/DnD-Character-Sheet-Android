...
public class AddEditCharacterItemsFragment extends Fragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			character.setArmors((ArrayList<String>) savedInstanceState
					.getSerializable(ARMOR));
			character.setWeapons((ArrayList<String>) savedInstanceState
					.getSerializable(WEAPONS));
			character.setMisc((ArrayList<String>) savedInstanceState
					.getSerializable(MISC));
			character.setExtras((ArrayList<String>) savedInstanceState
	...
	private void loadData() {
		...
		// clear the hashmaps since we are reloading them anyway to ensure no
		// duplicates
		armors.clear();
		weapons.clear();
		misc.clear();
