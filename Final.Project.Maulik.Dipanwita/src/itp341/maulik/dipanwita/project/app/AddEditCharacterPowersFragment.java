...
public class AddEditCharacterPowersFragment extends Fragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null)
		{
			...
			character.setFeats((ArrayList<String>)savedInstanceState.getSerializable(FEATS));
			character.setSkills((ArrayList<String>)savedInstanceState.getSerializable(SKILLS));
			character.setLanguages((ArrayList<String>)savedInstanceState.getSerializable(LANGUAGES));
			character.setMagic((ArrayList<String>)savedInstanceState.getSerializable(MAGIC));
		} else {
